...
# Test main endpoints
curl -s https://your-distribution.cloudfront.net/api/enhanced/health | grep -o '"status":"[^"]*"' || echo "Testing..."
curl -s https://your-distribution.cloudfront.net/fhir/R4/metadata | grep -o '"resourceType":"[^"]*"' || echo "FHIR testing..."
